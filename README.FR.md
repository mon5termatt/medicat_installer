...
### Nous apprécions les améliorations apportées au code de l’installateur !
Si vous voulez nous aider à améliorer l’installateur Medicat, vous pouvez :
* Rejoindre le Discord : (https://url.medicatusb.com/discord),

OU :

* Faire un fork de ce projet et créer une pull request avec les fichiers modifiés.

# Compatibilité
* Windows 10/11 (les versions Insider peuvent casser l’installateur)
* Ubuntu / Arch / Debian / CentOS / FreeBSD / Fedora

#### Prérequis pour Windows
* Windows 1703+ (versions publiées après 2017)
* cURL
* Un demi-cerveau

#### Prérequis pour Linux
* L'accès au Terminal
* Quelque chose comme 75% de cerveau
* Des connaissances globales de Linux

# Fichiers principaux
### Medicat_Installer.bat
Contient le code nécessaire pour télécharger et installer les fichiers Medicat

### Medicat_Installer.sh
Fichier principal pour l’installation via la ligne de commande Linux
...
# Programmes inclus / téléchargés pendant l’installation
  ...
  2. [7Zip](https://www.7-zip.org/)  
      * Pour l’extraction des fichiers  
  3. [IPget](https://github.com/ipfs/ipget)  
      * En gros, un wget pour IPFS  
  ...
  5. [QuickSFV](http://www.quicksfv.org/)  
      * Pour le hachage des gros fichiers *relativement* rapidement…  
...
* Ainsi que tous les autres qui aident sur le serveur Discord !
